public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (count != 3) {
            System.out.println("(" + i + ") MA. MARGARITA JANA");
            count++;
            i++;
        }
        ...
        char[] initial = {'M','A',' ','M','A','R','G','A','R','I','T','A',' ','J','A','N','A'};
        ...
        char[] ini = {'M','A',' ','M','A','R','G','A','R','I','T','A',' ','J','A','N','A'};
